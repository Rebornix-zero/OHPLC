char * PLC_file_name="softplc_socket_aarch64";
/**
...
int __init_100(int argc,char **argv);
void __cleanup_100(void);
void __retrieve_100(void);
void __publish_100(void);
...
int __init(int argc,char **argv)
{
    ...
    init_level=2; if((res = __init_100(argc,argv))){return res;}
    return res;
}
/*
