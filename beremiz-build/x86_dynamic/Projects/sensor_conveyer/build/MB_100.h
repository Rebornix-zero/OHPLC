...
/* Values for instance 100 of the modbus plugin */
...
/*node 100.0*/
{"100.0", "Modbus TCP Client 100.0", "192.168.157.1", "502", {naf_tcp, {.tcp = {NULL, NULL, DEF_CLOSE_ON_SILENCE}}}, -1 /* mb_nd */, 0 /* init_state */, 100 /* communication period */, 0 /* prev_error */}
};


static client_request_t	client_requests[NUMBER_OF_CLIENT_REQTS] = {
/*request 100_0_0*/
{"100_0_0", 0, 1, req_input, 2, 0 , 1,
DEF_REQ_SEND_RETRIES, 0 /* mb_error_code */, 0 /* tn_error_code */, 0 /* prev_code */, {0, 10000000} /* timeout */, 0 /* write_on_change */, 
{0}, {0}},

/*request 100_0_1*/
{"100_0_1", 0, 1, req_output, 5, 0 , 1,
DEF_REQ_SEND_RETRIES, 0 /* mb_error_code */, 0 /* tn_error_code */, 0 /* prev_code */, {0, 10000000} /* timeout */, 0 /* write_on_change */, 
{0}, {0}},

/*request 100_0_2*/
{"100_0_2", 0, 1, req_input, 2, 1 , 1,
DEF_REQ_SEND_RETRIES, 0 /* mb_error_code */, 0 /* tn_error_code */, 0 /* prev_code */, {0, 10000000} /* timeout */, 0 /* write_on_change */, 
{0}, {0}},

/*request 100_0_3*/
{"100_0_3", 0, 1, req_output, 5, 1 , 1,
DEF_REQ_SEND_RETRIES, 0 /* mb_error_code */, 0 /* tn_error_code */, 0 /* prev_code */, {0, 10000000} /* timeout */, 0 /* write_on_change */, 
{0}, {0}}
};
...
u16 *__IX100_0_0_0 = &client_requests[0].plcv_buffer[0];
u16 *__QX100_0_1_0 = &client_requests[1].plcv_buffer[0];
u16 *__IX100_0_2_1 = &client_requests[2].plcv_buffer[0];
u16 *__QX100_0_3_1 = &client_requests[3].plcv_buffer[0];
